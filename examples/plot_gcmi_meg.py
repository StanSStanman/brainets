...
# Subject 1
data_1, dp_1, roi_1 = gcmi_random_dataset(n_trials=100, random_state=2, **kw)
# Subject 2
data_2, dp_2, roi_2 = gcmi_random_dataset(n_trials=150, random_state=3, **kw)
...
del data_1, data_2, dp_1, dp_2, data
